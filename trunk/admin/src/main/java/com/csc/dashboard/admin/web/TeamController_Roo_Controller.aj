...
privileged aspect TeamController_Roo_Controller {
    ...
    public String TeamController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String TeamController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        uiModel.addAttribute("team", Team.findTeam(id));
        return "teams/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE)
    public String TeamController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
